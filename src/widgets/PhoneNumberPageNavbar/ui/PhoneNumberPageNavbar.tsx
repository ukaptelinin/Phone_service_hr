  ...
  return (
    <HeroUINavbar maxWidth="xl" position="sticky" className="flex flex-row">
      <NavbarContent className="flex flex-1 justify-between">
        <NavbarItem><Link className='px-4'>Сценарий</Link ></NavbarItem>
         <NavbarItem><Link className='px-4'>История</Link></NavbarItem>
          <NavbarItem><Link className='px-4'>Задачи</Link></NavbarItem>
      </NavbarContent>
    </HeroUINavbar>
  );
};